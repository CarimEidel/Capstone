      ...
      <div class="col-md-4">
         ...
         <div class="card-body">
            ...
            try {
                ...
                String sql = "SELECT (SELECT COUNT(*) FROM products) AS Total_Products, (SELECT COUNT(*) FROM users)  AS Total_Users, (SELECT  COUNT(*) FROM product_report)  AS Total_Reports FROM dual";
